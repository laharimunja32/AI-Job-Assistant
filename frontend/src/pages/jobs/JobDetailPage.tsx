...
import { ExternalLink, FileText, Mail, ArrowLeft, Bookmark } from 'lucide-react';
import {
  useJob,
  useMatchJob,
    ...
    <div className="mx-auto max-w-4xl space-y-6">
            ...
            <>
              <div className="grid gap-3 sm:grid-cols-2">
                <Card>
                  ...
                  <p className="text-xl font-bold">{tailoredResume.ats_score ?? '—'}</p>
                </Card>
                <Card>
            ...
            <>
              <div className="grid gap-3 sm:grid-cols-2">
                <Card>
                  ...
                  <p className="text-xl font-bold">{generatedCoverLetter.quality_score ?? '—'}</p>
                </Card>
                <Card>
                  <p className="text-xs text-slate-500">Generated At</p>
      ...
      <Card>
        ...
        <dl className="grid gap-3 text-sm sm:grid-cols-2">
          <div><dt className="text-slate-500">Experience</dt><dd className="font-medium">{job.experience ?? '—'}</dd></div>
          <div><dt className="text-slate-500">Source</dt><dd className="font-medium">{job.source ?? '—'}</dd></div>
